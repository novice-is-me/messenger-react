    ...
    <div className='sideOptions'>
      <div className='sideOptions-container'>
        ...
        <div className='sideOptions-middle d-flex align-items-center justify-content-center my-3'>
          <a href="" style={{marginRight:"1rem"}}>{<IoNotificationsOffOutline 
          size={25} className='sideOptions-icon'/>}</a>
          <a href="">{<IoSearchOutline size={25} className='sideOptions-icon'/>}</a>
        </div>
